...
const ConfirmBtns = ({ isforDelete, firstBtnContent, secondBtnContent }: ConfirmBtnsProps) => {
  return (
    <S.ModalBtns>
      <S.ModalBtn $isPurple={false} order={isforDelete ? 0 : 1}>
        {firstBtnContent}
      </S.ModalBtn>
      <S.ModalBtn $isPurple={true} order={isforDelete ? 1 : 0}>
        {secondBtnContent}
      </S.ModalBtn>
    </S.ModalBtns>
  );
