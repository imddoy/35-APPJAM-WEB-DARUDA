import { DetailToolResponse } from '@apis/tool';

export const DETAIL_RESPONSE: { statusCode: number; message: string; data: DetailToolResponse } = {
  statusCode: 200,
  ...
  data: {
    ...
    images: [
      'https://daruda.s3.ap-northeast-2.amazonaws.com/94_anaconda_1.png',
      'https://daruda.s3.ap-northeast-2.amazonaws.com/94_anaconda_1.png',
      'https://daruda.s3.ap-northeast-2.amazonaws.com/94_anaconda_1.png',
    ],
    bgColor: '#162230',
    ...
    isScrapped: false,
    toolLogo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/ChatGPT_logo.svg/1024px-ChatGPT_logo.svg.png',
  },
};
