...
const SvgImgPopupmodal84 = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#img_popupmodal_84_svg__a)" d="M0 84h148V0H0z" />
    <defs>
      <pattern id="img_popupmodal_84_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#img_popupmodal_84_svg__b" transform="matrix(.0039 0 0 .00688 0 -.381)" />
      </pattern>
      <image
...
export default SvgImgPopupmodal84;
