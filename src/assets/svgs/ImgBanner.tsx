...
const SvgImgBanner = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#Img_Banner_svg__a)" d="M0 0h406v206H0z" />
    <defs>
      <pattern id="Img_Banner_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#Img_Banner_svg__b" transform="matrix(.0039 0 0 .0077 0 -.485)" />
      </pattern>
      <image
